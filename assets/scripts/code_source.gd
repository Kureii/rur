...
Vyšel jsem do ulice a aktivoval augmentovaný zrak. Město se rozostřilo do kaleidoskopu, filtrovaného mým starým {3}{4} algoritmem. Hledal jsem digitální otisky. Anomálie.
